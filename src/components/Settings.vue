  ...
  <div class="h-full overflow-y-auto px-5 pb-5 pt-16">
    <div class="mx-auto flex h-full max-w-5xl flex-col">
      <div class="mb-4 grid gap-3 md:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)]">
        <section class="rounded-[20px] border border-black/[0.06] bg-white px-6 py-5 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
          <div class="mb-3 inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-black/[0.06] bg-[#f5f1ea] text-foreground/80 dark:border-white/18 dark:bg-black/[0.7]">
            <Sparkles class="h-5 w-5" />
          </div>
          <h2 class="text-[28px] font-semibold tracking-tight text-foreground/92">{{ $t('settings.title') }}</h2>
          <p class="mt-2 max-w-xl text-sm leading-6 text-foreground/56">
            {{ $t('settings.pageIntro') }}
          </p>
        </section>

        <aside class="rounded-[20px] border border-black/[0.06] bg-white px-5 py-5 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
          <p class="text-xs font-medium uppercase tracking-[0.18em] text-foreground/38">{{ $t('settings.current') }}</p>
          <div class="mt-4 space-y-4">
            <div class="flex items-center justify-between rounded-[16px] border border-black/[0.06] bg-[#f7f4ee] px-4 py-3 dark:border-white/16 dark:bg-black/[0.68]">
              <div class="flex items-center gap-3">
                <Palette class="h-4 w-4 text-foreground/56" />
                <span class="text-sm text-foreground/72">{{ $t('settings.theme') }}</span>
              </div>
              <span class="text-sm font-medium text-foreground/90">{{ selectedThemeLabel }}</span>
            </div>
            <div class="flex items-center justify-between rounded-[16px] border border-black/[0.06] bg-[#f7f4ee] px-4 py-3 dark:border-white/16 dark:bg-black/[0.68]">
              <div class="flex items-center gap-3">
                <Globe2 class="h-4 w-4 text-foreground/56" />
                <span class="text-sm text-foreground/72">{{ $t('settings.language') }}</span>
              </div>
      ...
      <div class="grid flex-1 gap-3 md:grid-cols-[minmax(0,1.2fr)_minmax(280px,0.8fr)]">
        <div class="space-y-3">
          <section class="rounded-[20px] border border-black/[0.06] bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
            <div class="mb-5 flex items-start justify-between gap-4">
              <div>
                <p class="text-base font-semibold text-foreground/90">{{ $t('settings.theme') }}</p>
                <p class="mt-1 text-sm leading-6 text-foreground/56">{{ $t('settings.themeDesc') }}</p>
              </div>
              <div class="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-black/[0.06] bg-[#f5f1ea] dark:border-white/18 dark:bg-black/[0.7]">
            ...
            <div class="grid gap-3 md:grid-cols-3">
              <button
                ...
                :class="settings.theme === 'light'
                  ? 'border-black/12 bg-[#f7f3ec] shadow-[0_14px_32px_rgba(15,23,42,0.08)] dark:border-white/24 dark:bg-black/[0.74]'
                  : 'border-black/[0.06] bg-[#fcfaf7] hover:bg-[#f7f2eb] dark:border-white/16 dark:bg-black/[0.68] dark:hover:bg-black/[0.76]'"
              ...
              >
                ...
                <p class="mt-1 text-xs leading-5 text-foreground/54">{{ $t('settings.themeLightDesc') }}</p>
              </button>
              ...
              >
                ...
                <p class="mt-1 text-xs leading-5 text-foreground/54">{{ $t('settings.themeDarkDesc') }}</p>
              </button>
              ...
              >
                ...
                <p class="mt-1 text-xs leading-5 text-foreground/54">{{ $t('settings.themeSystemDesc') }}</p>
              </button>
            </div>
          </section>
          ...
          <section class="rounded-[20px] border border-black/[0.06] bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
            <div class="mb-5 flex items-start justify-between gap-4">
              <div>
                ...
                <p class="mt-1 text-sm leading-6 text-foreground/56">{{ $t('settings.languageDesc') }}</p>
              </div>
              <div class="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-black/[0.06] bg-[#f5f1ea] dark:border-white/18 dark:bg-black/[0.7]">
            ...
            <div class="grid gap-3 md:grid-cols-2">
              ...
              >
                <div>
                  ...
                  <p class="mt-1 text-xs text-foreground/54">{{ $t('settings.languageZhDesc') }}</p>
                </div>
                <span class="text-xs font-medium text-foreground/44">ZH</span>
              </button>
              ...
              >
                <div>
                  ...
                  <p class="mt-1 text-xs text-foreground/54">{{ $t('settings.languageEnDesc') }}</p>
                </div>
                <span class="text-xs font-medium text-foreground/44">EN</span>
              </button>
            </div>
          </section>
        </div>
        ...
        <aside class="space-y-3">
          <section class="rounded-[20px] border border-black/[0.06] bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
            <div class="mb-5 flex items-start justify-between gap-4">
              <div>
                ...
                <p class="mt-1 text-sm leading-6 text-foreground/56">{{ $t('settings.updateDesc') }}</p>
              </div>
              <div class="inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-black/[0.06] bg-[#f5f1ea] dark:border-white/18 dark:bg-black/[0.7]">
            ...
            <div class="relative">
              <Button
                variant="outline"
                class="relative h-12 w-full overflow-hidden rounded-[16px] border-black/[0.06] bg-[#fcfaf7] text-foreground shadow-[0_12px_30px_rgba(15,23,42,0.08)] hover:bg-[#f7f2eb] dark:border-white/18 dark:bg-black/[0.7] dark:hover:bg-black/[0.8]"
          ...
          <section class="rounded-[20px] border border-black/[0.06] bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.08)] dark:border-white/20 dark:bg-black/[0.58] dark:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.08),0_16px_40px_rgba(0,0,0,0.28)]">
            <p class="text-xs font-medium uppercase tracking-[0.18em] text-foreground/38">{{ $t('settings.tips') }}</p>
            <div class="mt-4 space-y-3 text-sm leading-6 text-foreground/56">
